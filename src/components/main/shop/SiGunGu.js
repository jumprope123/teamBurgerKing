...
const SiGunGu = (props) => {
  ...
  const [listGuGun, setListGuGun] = useState([
    "군, 구",
    "강남구",
    "강동구",
    "강북구",
  ...
  useEffect(() => {
    ...
    switch (si) {
      ...
      case "인천광역시":
        ...
        break;
      case "대전광역시":
        setListGuGun(["군, 구", "대덕구", "동구", "서구", "유성구", "중구"]);
        break;
      case "광주광역시":
        setListGuGun(["군, 구", "광산구", "남구", "동구", "북구", "서구"]);
        break;
      case "대구광역시":
        setListGuGun([
          "군, 구",
        ...
        break;
      case "울산광역시":
        setListGuGun(["군, 구", "남구", "동구", "북구", "중구", "울주군"]);
        break;
      case "부산광역시":
        setListGuGun([
          "군, 구",
      ...
      case "경상남도":
        ...
        break;
      case "제주도":
        setListGuGun(["군, 구", "서귀포시", "제주시", "남제주군", "북제주군"]);
        break;
    }
  }, [si]);
  ...
  return (
    <div className={"displayFlex justify-content-center textAlignCenter"}>
      <select
        ...
        value={si}
      >
        <option disabled={true}>특별/광역시</option>
        <option autofocus={true} value={"서울특별시"}>
          서울특별시
        </option>
